...
class payment extends controller {
    ...
    function index() {
        ...
        $this->view->titl = 'Select payment method on DotNetNow';
        $this->view->description = 'Select payment method on DotNetNow';
    ...
    function view($postId) {
        ...
        $merchant_id = 'i71658652626'; //Вписывайте сюда свой мерчант
        $signature = "NdIKOaHg7r1TulEe82hIzrmt8UqqYnuYtXUdXDnt"; //Сюда вносите public_key
...
//$order_id = $_GET['order_id']; //Можно так принять назначение платежа
        ...
        $html = $liqpay->cnb_form(array(
            ...
            'order_id' => $order_id,
            'language' => 'en',
            'server_url' => 'http://dotnetnow.com/thanks/callback',
            'result_url' => 'http://dotnetnow.com/thanks/success'
            //'sandbox' => '1'
        ));
