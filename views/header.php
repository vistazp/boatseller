...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?= (isset($this->titl)) ? $this->titl : 'Dotnetnow: best jobs board on .NET'; ?></title>
        ...
        <meta name="og:title" content="<?= (isset($this->titl)) ? $this->titl : 'Dotnetnow: best jobs board on .NET'; ?>" />
        ...
        <meta name="og:site_name" content="Dotnetnow.com: .NET jobs board" />
            ...
            <div id="header" class="span-24">
                ...
                <div id="navigation" class="span-17 last">
                    <div id="top-nav" class="span-17 last">
                        ...
                        <a href="http://feeds.feedburner.com/dotnetboard" class="rss">RSS</a> |
                    ...
                    <div id="subscribe" class="span-17 prepend-0 last">
                        <div class="span-11 prepend-4 last">
                            <div class="span-11">
                                ...
                                <div class="span-4" id="twitter-div"><a href="https://twitter.com/dotnetnowboard" class="twitter-follow-button" data-show-count="false" data-lang="en">Follow @DotNetNowBoard</a></div>
                            </div>
                            <div class="span-11">
