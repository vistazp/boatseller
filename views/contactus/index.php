...
<option value="COMMENT">I have a comment</option></select>
    ...
    <input class="submit button inline" id="feedback_form_submit" name="commit" style="font-size: 15px; padding: 1em 2em;" type="submit" value="Send your comment" />
  ...
  <div class="span-6 last"> 
    ...
    <div class="textwidget">
      ...
      <p class="txt12">
        Dotnetnow (a subsidiary of Pozitive Group LLC), <br />
        5 St Minskaya St<br />
