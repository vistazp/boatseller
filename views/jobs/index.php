    ...
    <div id="job" class="span-24 last">
        ...
        <div id="sidebar" class="span-4 last">
            ...
            <div class="span-4 last align-center">
                ...
                <hr class="space"/>
                <hr/>
                <a href="<?php echo URL; ?>jobs/view/305"><img src="<?php echo URL; ?>public/images/ultra/mercury.jpg" alt="Junior Full-Stack .NET Developer" /></a>
                <hr class="space"/>
                <hr/>
                <a href="<?php echo URL; ?>jobs/view/307"><img src="<?php echo URL; ?>public/images/ultra/exe.jpg" alt=".NET Application Developers" /></a>
                <hr class="space"/>
                <hr/>
                <a href="mailto:admin@dotnetnow@com" ><img src="<?php echo URL; ?>public/images/ad_banner_right.jpg" alt="Ultra posting package" /></a>    
                <br/>
                <hr class="space"/>
                <hr/>
                <a href="mailto:admin@dotnetnow@com" ><img src="<?php echo URL; ?>public/images/ad_banner_right.jpg" alt="Ultra posting package" /></a>    
